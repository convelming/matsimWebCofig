<!-- TreeItem -->
<template>
  <div class="TreeItem UploadImageItem" v-bind="$attrs">
    <div class="content">
      <el-checkbox
        @click.stop
        v-model="check"
  ...
  <UploadImage v-model:visible="showDialog" v-model:visibleLayer="check" />
</template>

<script setup>
import UploadImage from '../../../upload/UploadImage/index.vue'
