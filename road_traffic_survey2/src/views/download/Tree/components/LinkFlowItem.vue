<!-- TreeItem -->
<template>
  <div class="TreeItem LinkFlowItem" v-bind="$attrs">
    <div class="content">
      <el-checkbox
        @click.stop
        v-model="check"
  ...
  <LinkFlow v-model:visible="showDialog" v-model:visibleLayer="check" />
</template>
...
import LinkFlow from '../../../upload/LinkFlow/index.vue'
