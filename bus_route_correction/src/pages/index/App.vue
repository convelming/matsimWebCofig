  ...
  <div id="app" class="App">
    <div class="home">
      <div class="nav">
        ...
        <a class="module_menu" :href="`${env.VUE_APP_PUBLIC_PATH}/user.html`">登录</a>
        <a class="module_menu" href="/console/console.html">建模</a>
        <a class="module_menu" :href="`${env.VUE_APP_PUBLIC_PATH}/pt.html`">可视化</a>
      </div>
      ...
      <a class="bodyer_item one" href="/console/console.html">
        ...
        <div class="text_box">
          ...
          <div class="text2">建立ActivitySim，</div>
          <div class="text2">UrbanSim与MATSim模型</div>
      ...
      <a class="bodyer_item two" :href="`${env.VUE_APP_PUBLIC_PATH}/pt.html`">
        <img src="@/assets/image/home/项目.svg?url" alt="" class="icon" />
        <div class="text_box">
          <div class="text1">MATSim可视化</div>
          <div class="text2">大规模活动出行链</div>
          <div class="text2">城市模型可视化</div>
      ...
      <a class="bodyer_item three" href="/simhelp/index.html">
        ...
        <div class="text_box">
          ...
          <div class="text2">了解3Sim模型建模</div>
          <div class="text2">原理与过程</div>
      ...
      <a class="bodyer_item four" :href="`${env.VUE_APP_PUBLIC_PATH}/feedback.html`">
        <img src="@/assets/image/home/比例.svg?url" alt="" class="icon" />
        <div class="text_box">
          <div class="text1">意见和建议</div>
          <div class="text2">有任何意见和建议或合作</div>
          <div class="text2">意向，请联系我们</div>
        </div>
