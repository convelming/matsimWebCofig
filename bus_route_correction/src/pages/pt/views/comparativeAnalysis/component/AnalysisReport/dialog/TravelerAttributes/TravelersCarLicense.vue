...
import { TravelerAttributes_TravelersCarLicense } from "../../echart_utils";
  ...
  methods: {
    ...
    updateChart() {
      if (this._chart && this._chartData) {
        this._chart.setOption(TravelerAttributes_TravelersCarLicense(this._chartData, this.$l), true);
        this._chart.resize();
      }
    },
    // 获取图表配置
