...
<language>
{
  "出行变化决策树":{
    "zh-CN": "出行变化决策树",
    "en-US": "Trip Decision Changed Factor Analysis"
  },
  "图表":{
    "zh-CN": "图表",
    "en-US": "Chart"
...
import { TravelVariationTree_index } from "../../echart_utils";
  ...
  methods: {
    ...
    updateChart() {
      if (this._chart && this._chartData) {
        this._chart.setOption(TravelVariationTree_index(this._chartData, this.$l), true);
        this._chart.resize();
      }
    },
    // 获取图表配置
