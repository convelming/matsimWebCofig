...
export class ModelPool {
  ...
  modelsUrl = {
    // Monster_Truck: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Monster_Truck.gltf",
    SUV: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/SUV.gltf",
    // Pickup: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Pickup.gltf",
    // Hatchback: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Hatchback.gltf",
    // Sedan: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Sedan.gltf",
    // Muscle: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Muscle.gltf",
    // Muscle_2: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Muscle_2.gltf",
    // Van: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Van.gltf",
    // Ambulance: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Ambulance.gltf",
    Bus: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Bus.gltf",
    // Firetruck: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Firetruck.gltf",
    // Limousine: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Limousine.gltf",
    // Police_Sedan: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Police_Sedan.gltf",
    // Police_SUV: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Police_SUV.gltf",
    // Police_Muscle: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Police_Muscle.gltf",
    // Police_Sports: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Police_Sports.gltf",
    // Roadster: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Roadster.gltf",
    // Sports: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Sports.gltf",
    // Taxi: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Taxi.gltf",

    Subway: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Subway.gltf",
    Ferry: window.VUE_APP_EXTERNAL_FILE_PATH + "/models/Bus.gltf",
  };
