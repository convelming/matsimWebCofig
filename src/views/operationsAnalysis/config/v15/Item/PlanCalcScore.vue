              ...
              <div class="collapse">
                ...
                <div class="collapse_list">
                  <div class="collapse_item" v-for="(item, index) in form.Scoring" :key="item.uuid">
                    <div class="collapse_item_header" :class="{ open: item.open }" @click="item.open = !item.open">
                            ...
                            <div class="collapse_list">
                              <template v-for="(amItem, amIndex) in item.Activitys">
                                <div class="collapse_item" :key="amItem.uuid" v-if="amItem.type == 'Activity'">
                                  <div class="collapse_item_header" :class="{ open: amItem.open }" @click="amItem.open = !amItem.open" style="top: 155px; z-index: 970">
                                    <div class="el-icon-arrow-right"></div>
