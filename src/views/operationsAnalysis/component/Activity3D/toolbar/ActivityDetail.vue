<template>
  <el-collapse-item class="ActivityDetail" :name="name">
    <div class="collapse_item_title" slot="title">{{ $l("活动详情") }}</div>
      ...
      <div class="form" v-if="activityDetail">
        ...
        <div style="margin: 20px 0 0 20px" v-if="showActivityRoutes">
          ...
          <div class="form_item" style="align-items: center">
            ...
            <div class="form_value">
              <el-slider style="padding: 0 calc(2em - 10px)" v-model="height" :min="0" :max="100" :format-tooltip="(v) => `${v}%`" />
            </div>
          </div>
        </div>
      </div>
