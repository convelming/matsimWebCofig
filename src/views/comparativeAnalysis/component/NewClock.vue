  ...
  <div class="box">
    <div class="top">
      ...
      <div v-show="showFun" class="bug">
        <a href="https://doc.weixin.qq.com/sheet/e3_AdQA8Aa_ADMt1qh97LkSHer6ALqI2?scode=APwA6gfEAA0aeGdABPAdQA8Aa_ADM&tab=f2oofj" target="_blank">
      ...
      <el-dropdown v-show="showFun" class="language" @command="changeLanguage" placement="top-start" trigger="click">
        <div class="locale">
