<template>
  <!-- 出行者机动车保有量 -->
  <Dialog class="TravelersCarLicense" ref="dialog" :title="$l('出行者机动车保有量')" hideMinimize :visible="s_show" @close="close" :left="100 + this.offset / 2" :top="20 + this.offset" width="640px">
    <div class="toolbar">
