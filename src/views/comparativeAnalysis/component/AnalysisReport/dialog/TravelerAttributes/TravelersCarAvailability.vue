<template>
  <!-- 出行者车辆可使用情况 -->
  <Dialog class="TravelersCarAvailability" ref="dialog" :title="$l('出行者车辆可使用情况')" hideMinimize :visible="s_show" @close="close" :left="100 + this.offset / 2" :top="20 + this.offset" width="640px">
    <div class="toolbar">
