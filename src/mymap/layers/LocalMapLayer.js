...
// 瓦片类
export class LocalMapTile {
  // 瓦片名称
  static NAME = "LocalMapTile";
  // 地图背景色
...
export const MAP_LAYER_STYLE = {
  DARK_MATTER: class extends LocalMapTile {
  ...
  MAPBOX: class extends LocalMapTile {
    static NAME = "MAPBOX";
    get url() {
      // const token =
...
// 地图图层类
export class LocalMapLayer extends Layer {
  name = "LocalMapLayer";
  ...
  setTileClass(tileClass) {
    if (new tileClass() instanceof LocalMapTile) {
      ...
      console.error("tileClass must be a subclass of LocalMapTile");
    }
  }
