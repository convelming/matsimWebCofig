import { MAP_EVENT, Layer } from "@/mymap/index";
...
export class MapLayer extends Layer {
  ...
  loadMesh() {
    ...
    const tileList = TileUtils.getTileList(zoom, this.map.center, width);
...
export class MapTile {
  ...
  constructor(zoom, row, col, size) {
    ...
    this._x = TileUtils.rowToDrawX(this.row, this.zoom, [0.5, 0.5]);
    this._y = TileUtils.colToDrawY(this.col, this.zoom, [0.5, 0.5]);
