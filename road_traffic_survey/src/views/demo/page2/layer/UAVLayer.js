...
export class UAVLayer extends Layer {
  ...
  constructor(opt) {
    ...
    this.nodesMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, opacity: 0.3, transparent: true });

    this.linksGeometry = new THREE.BufferGeometry();
    this.linksMaterial = new THREE.LineBasicMaterial({ color: 0xffffff, opacity: 0.3, transparent: true });
