...
import { ColorBar2D } from "./ColorBar2D2";
...
export class GeoJSONLayer extends Layer {
  ...
  setPointValue(pointValue) {
    ...
    this.pointMaterial.setColorBar(this.pointColorBar, !!this.pointValue && !this.pointColorBar.isNull());
  ...
  setPointHeight(pointHeight) {
    ...
    this.pointMaterial.uniforms.pointHeight.value = this.pointHeight;
    this.pointPickLayerMaterial.uniforms.pointHeight.value = this.pointHeight;
    this.pointPickItemMaterial.uniforms.pointHeight.value = this.pointHeight;
  }
  ...
  setLineValue(lineValue) {
    ...
    this.lineMaterial.setColorBar(this.lineColorBar, !!this.lineValue && !this.lineColorBar.isNull());
  ...
  setLineHeight(lineHeight) {
    ...
    this.lineMaterial.uniforms.lineHeight.value = this.lineHeight;
    this.lineMaterial.needsUpdate = true;
    this.linePickLayerMaterial.uniforms.lineHeight.value = this.lineHeight;
    this.linePickLayerMaterial.needsUpdate = true;
    this.linePickItemMaterial.uniforms.lineHeight.value = this.lineHeight;
    this.linePickItemMaterial.needsUpdate = true;
  }
  ...
  setPolygonValue(polygonValue) {
    ...
    this.polygonMaterial.setColorBar(this.polygonColorBar, !!this.polygonValue && !this.polygonColorBar.isNull());
    ...
    this.polygonBorderMaterial.setColorBar(this.polygonColorBar, !!this.polygonValue && !this.polygonColorBar.isNull());
  }
  ...
  setPolygonHeight(polygonHeight) {
    ...
    this.polygonMaterial.uniforms.polygonHeight.value = this.polygonHeight;
    this.polygonMaterial.needsUpdate = true;
    this.polygonPickLayerMaterial.uniforms.polygonHeight.value = this.polygonHeight;
    this.polygonPickLayerMaterial.needsUpdate = true;
    this.polygonPickItemMaterial.uniforms.polygonHeight.value = this.polygonHeight;
    this.polygonPickItemMaterial.needsUpdate = true;

    this.polygonBorderMaterial.uniforms.polygonHeight.value = this.polygonHeight;
    this.polygonBorderMaterial.needsUpdate = true;
  }
  ...
  constructor(opt) {
    ...
    this.setPointHeight(params.pointHeight);
...
export class GeoJSONPointMaterial extends THREE.Material {
  constructor(argu) {
    ...
    const { color = 0xff0000, opacity = 1, size = 50, map = null, colorBar = null, usePickColor = false, pointHeight = 1, ...params } = argu || {};
    this.alphaTest = 0.2;
    ...
    this.vertexShader = `
      ...
      void main() {
        ...
        gl_Position = projectionMatrix * modelViewMatrix * vec4( transformed.xy, transformed.z + p * pointHeight, 1.0 );
...
export class GeoJSONLineMaterial extends THREE.Material {
  constructor(argu) {
    super();
    this.isGeoJSONLineMaterial = true;
    const { color = 0xff0000, opacity = 1, lineStyle = LINE_STYLE.SOLID, lineWidth = 50, lineWidthStyle = LINE_WIDTH_STYLE.UNAUTO, lineOffset = 0, colorBar = null, usePickColor = false, lineAnimation = 0, lineHeight = 1, ...params } = argu || {};
    // this.alphaTest = 0.1;
    // this.transparent = true;
    ...
    this.vertexShader = `
      ...
      void main() {
        ...
        gl_Position = projectionMatrix * modelViewMatrix * vec4( transformed.xy, transformed.z + p * lineHeight, 1.0 );
...
export class GeoJSONPolygonMaterial extends THREE.Material {
  constructor(argu) {
    super();
    this.isGeoJSONLineMaterial = true;
    const { color = 0xff0000, opacity = 1, size = 50, colorBar = null, usePickColor = false, polygonHeight = 1, ...params } = argu || {};
    this.defines = {
      USE_COLOR_BAR: !!colorBar,
      USE_3D: false,
      USE_PICK_COLOR: usePickColor,
    ...
    this.vertexShader = `
      ...
      void main() {
        ...
        gl_Position = projectionMatrix * modelViewMatrix * vec4( transformed.xy, transformed.z + p * polygonHeight, 1.0 );
...
export class GeoJSONPolygonBorderMaterial extends THREE.Material {
  constructor(argu) {
    ...
    const { color = 0xff0000, opacity = 1, lineStyle = LINE_STYLE.SOLID, lineWidth = 50, lineOffset = 0, colorBar = null, polygonHeight = 1, ...params } = argu || {};
    this.defines = {
      USE_COLOR_BAR: !!colorBar,
      USE_3D: false,
    };
