...
// import { TianDiTiTileUtils } from "@/mymap/utils/TianDiTiTileUtils.js";
...
export class TileMesh extends THREE.Mesh {
  ...
  updateTile() {
    function getUrl(row, col, zoom) {
      // 天地图
      return `http://t0.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX=${zoom}&TILEROW=${row}&TILECOL=${col}&tk=fcaaabe9f71c6322310f751c434a8a2b` 
      // 百度算法
