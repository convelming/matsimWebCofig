...
import TransformClassTianDiTu from './transform-class-tianditu';
const TileLnglatTransformTianDiTu = new TransformClassTianDiTu(MapLevelRange[MapTypes.TianDiTu].max, MapLevelRange[MapTypes.TianDiTu].min);
...
export {
    ...
    TileLnglatTransformTianDiTu as TileLnglatTransformTianDiTu,
};
