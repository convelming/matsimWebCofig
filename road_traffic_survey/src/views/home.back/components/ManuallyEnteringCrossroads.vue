<template>
  <Dialog class="ManuallyEnteringCrossroads" title="人工录入交叉口" :top="50" :left="100" width="600px" hideMinimize :visible="visible" @close="handleClose">
...
export default {
  name: "ManuallyEnteringCrossroads",
  inject: ["rootVue"],
  props: {
    visible: {
      type: Boolean,
