  ...
  <div>
    <Dialog class="LinkFlowDialog" title="Link流量详情" :top="20" :left="20" width="800px" hideMinimize :visible="visible && !open" @close="handleClose">
      <div class="LinkFlow">
        <div class="_search">
          <el-form ref="form" label-width="auto" :inline="true" size="mini">
            <el-form-item label="路段搜索">
              <RouteSelect style="width: 100%" v-model="selectValue" size="mini" />
            </el-form-item>
            <el-form-item>
              <el-button type="primary" size="mini" @click="handleMoveToRoute">搜索定位</el-button>
            </el-form-item>
          </el-form>
        </div>
        ...
        <div class="_bodyer" style="height: 50vh; display: flex; align-items: center; justify-content: center; font-size: 30px; color: #c5c5c5; font-weight: bold" v-else>请在地图点击路段</div>
      </div>
    </Dialog>
    <!-- 添加或修改参数配置对话框 -->
