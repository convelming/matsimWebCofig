...
页面位于 [views](./src/views/) 目录，采用「布局页 + 子路由页」两级结构。

### 1. 3D 地图布局 ([MapLayout.vue](./src/views/MapLayout.vue))
...
### 2. 航路规划主页 ([routeplan/index.vue](./src/views/routeplan/index.vue))
...
| 组件 | 路径 | 说明 |
|------|------|------|
| CustomTitle | [CustomTitle.vue](./src/components/CustomTitle.vue) | 标题组件（可选底部装饰底图 [bottom-shape.png](./src/assets/images/bottom-shape.png)） |
| MInput | [MInput.vue](./src/views/routeplan/components/MInput.vue) | 带标题前缀的表单输入框 |
| MSelect | [MSelect.vue](./src/views/routeplan/components/MSelect.vue) | 带标题前缀的下拉选择器（label-key / value-key 自定义） |
| MTimePicker | [MTimePicker.vue](./src/views/routeplan/components/MTimePicker.vue) | 带标题前缀的时间选择器 |
...
| 图层 | 路径 | 说明 |
|------|------|------|
| UamLayer | [UamLayer.js](./src/views/routeplan/layers/UamLayer.js) | 无人机航线层：按时间驱动飞机模型沿航路点移动、goToStart 定位、updateRunnerByTime 帧更新 |
| PointLayer | [PointLayer.js](./src/views/routeplan/layers/PointLayer.js) | 起降点图层（点击取点回调） |
| Line2 系列 | [lines](./src/views/routeplan/layers/lines) | 宽线几何体与材质（含 Wireframe + WebGPU 备选实现） |
...
| 模块 | 文件 | 说明 |
|------|------|------|
| **入口** | [index.js](./src/mymap/index.js) | 导出 MyMap / Layer / MapLayer / OutlineLayer |
| **核心类** | [main/MyMap.js](./src/mymap/main/MyMap.js) | Three.js 场景封装：中心点、缩放级别、旋转、鼠标手势、相机、图层管理、dispose 资源释放 |
| **图层基类** | [main/Layer.js](./src/mymap/main/Layer.js) / [EventListener.js](./src/mymap/main/EventListener.js) | 生命周期、zIndex、事件体系 |
| **内置图层** | [layers/MapLayer.js](./src/mymap/layers/MapLayer.js) | 底图瓦片层（OSM/Baidu 工具在 utils） |
| | [layers/OutlineLayer.js](./src/mymap/layers/OutlineLayer.js) | 3D 建筑轮廓白膜层 |
| **后期合成** | [composer/BloomComposer.js](./src/mymap/composer/BloomComposer.js) | Bloom 辉光后期效果 |
| **材质** | [material/Line2DMaterial.js](./src/mymap/material/Line2DMaterial.js) | 屏幕空间 2D 宽线 Shader 材质 |
| **工具** | [utils/BaiduTileUtils.js](./src/mymap/utils/BaiduTileUtils.js) | 百度瓦片坐标换算 |
| | [utils/OSMTileUtils.js](./src/mymap/utils/OSMTileUtils.js) | OSM 瓦片坐标换算 |
| | [utils/LngLatUtils.js](./src/mymap/utils/LngLatUtils.js) | 经纬度 / Web 墨卡托互转 |
| | [utils/ColorBar2D.js](./src/mymap/utils/ColorBar2D.js) | 颜色图例条（连续色带） |
| | [utils/ModelPool.js](./src/mymap/utils/ModelPool.js) | 车辆/飞行器 3D 模型对象池（GLTF 缓存复用） |
| | [utils/lines/Line2.js](./src/mymap/utils/lines/Line2.js), [LineSegments2.js](./src/mymap/utils/lines/LineSegments2.js), [LineGeometry.js](./src/mymap/utils/lines/LineGeometry.js), [LineMaterial.js](./src/mymap/utils/lines/LineMaterial.js), [LineSegmentsGeometry.js](./src/mymap/utils/lines/LineSegmentsGeometry.js), [Wireframe.js](./src/mymap/utils/lines/Wireframe.js), [WireframeGeometry2.js](./src/mymap/utils/lines/WireframeGeometry2.js) | Fat Line 宽线实现（支持 WebGPU 版本） |
| | [utils/CSS2DRenderer.js](./src/mymap/utils/CSS2DRenderer.js) | DOM 标注 2D 渲染器 |
| **天空盒** | [skybox](./src/mymap/skybox) | 立方体贴图 6 面天空盒 |

---

## 通用业务图层工具 ([MapLayer](./src/utils/MapLayer))

可直接在 MyMap 中组合使用的 17 种业务图层：

| 图层文件 | 功能 |
|----------|------|
| [GeoJSONLayer.js](./src/utils/MapLayer/GeoJSONLayer.js) + [GeoJSONLayer.worker.js](./src/utils/MapLayer/GeoJSONLayer.worker.js) | GeoJSON 渲染（Web Worker 拆分大数据） |
| [PolygonsLayer.js](./src/utils/MapLayer/PolygonsLayer.js) | 多边形批量绘制 |
| [LinksLayer.js](./src/utils/MapLayer/LinksLayer.js) / [LinkLayer.js](./src/utils/MapLayer/LinkLayer.js) / [LinkStatsLayer.js](./src/utils/MapLayer/LinkStatsLayer.js) | 路段/连接线批量 + 统计着色 |
| [NetworkLayer.js](./src/utils/MapLayer/NetworkLayer.js) | 交通网络图（节点 + 边） |
| [GuangZhouLayer.js](./src/utils/MapLayer/GuangZhouLayer.js) | 广州市区域专题底图 |
| [ImageListLayer.js](./src/utils/MapLayer/ImageListLayer.js) | 多图片拼接栅格层 |
| [IntersectionListLayer.js](./src/utils/MapLayer/IntersectionListLayer.js) | 交叉口列表层 |
| [DrawLineLayer.js](./src/utils/MapLayer/DrawLineLayer.js) | 交互画线 |
| [FrameSelectLayer.js](./src/utils/MapLayer/FrameSelectLayer.js) | 框选交互 |
| [PolygonSelectLayer.js](./src/utils/MapLayer/PolygonSelectLayer.js) | 多边形圈选交互 |
| [PointSelectLayer.js](./src/utils/MapLayer/PointSelectLayer.js) | 点选交互 |
| [ColorBar2D.js](./src/utils/MapLayer/ColorBar2D.js) + [ColorBar2DUtil.js](./src/utils/MapLayer/ColorBar2DUtil.js) | 色带图例组件 |

---

## 路由配置

- 入口文件：[index.ts](./src/router/index.ts)
...
接口定义：[routeplan.js](./src/api/routeplan.js)（基于 [request.js](./src/utils/request.js) 的 Axios 封装）
...
- 接口前缀通过 [.env.development](./.env.development) / [.env.production](./.env.production) 切换

---

## 环境变量

| 变量 | 开发 [.env.development](./.env.development) | 生产 [.env.production](./.env.production) | 说明 |
|------|------|------|------|
...
### 3D 模型库 ([models](./public/external/models))
